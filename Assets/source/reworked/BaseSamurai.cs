...
public class BaseSamurai : MonoBehaviour {
	...
	private BaseDuelManager manager;			// The duel manager monitoring this player
	...
	public void SetManager(BaseDuelManager _manager) {
		manager = _manager;
	}
